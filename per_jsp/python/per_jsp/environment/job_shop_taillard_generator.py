...
import logging
from per_jsp.environment.job_shop_environment import Job, Operation
...
def verify_taillard_instance():
    ...
    problem_data = TaillardJobShopGenerator.load_file("/home/per/jsp/per_jsp/data/taillard_instances/ta01.txt")
    jobs, _ = TaillardJobShopGenerator.load_problem("/home/per/jsp/per_jsp/data/taillard_instances/ta01.txt")
