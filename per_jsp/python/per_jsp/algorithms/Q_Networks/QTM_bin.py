...
from  per_jsp.python.per_jsp.algorithms.Q_Networks.JSPBinarizer import JSPBinarizer  # Import the JSPBinarizer
...
class QTM:
    ...
    def __init__(self, env, Policy, config):
        ...
        self.binarizer = JSPBinarizer(env, feature_bits=feature_bits)
