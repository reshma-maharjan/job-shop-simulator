...
from per_jsp.python.per_jsp.algorithms.qtm_1 import HybridTsetlinQLearningScheduler, JSSPFeatureTransformer
...
def setup_argument_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--algorithm", type=str, 
                   choices=["greedy", "q-learning", "ppo", "dqn", "hybrid-tm-q"],
    ...
    # Hybrid Tsetlin Machine-Q Learning parameters
    parser.add_argument("--tm-clauses", type=int, default=2000,
