...
class CMakeBuild(build_ext):
    ...
    def run(self):
        ...
        # Create the build temp directory
        if not os.path.exists(self.build_temp):
            os.makedirs(self.build_temp)

        # Setup vcpkg inside build directory
        self._setup_vcpkg()
    ...
    def _setup_vcpkg(self):
        ...
        try:
            # Clean or create vcpkg directory
            ...
            # Handle vcpkg.json if specified
            if manifest_path:
    ...
    def _install_vcpkg_packages(self, vcpkg_root):
        ...
        # Get packages list based on platform
    ...
    def _get_cmake_args(self, ext, extdir, nanobind_path):
        """Get CMake configuration arguments from pyproject.toml."""
        # Get source directory from config or use default
    ...
    def _configure_cmake(self, ext, cmake_args, build_temp, env):
        """Configure CMake project based on pyproject.toml settings."""
